...
class ContactsApi {
    ...
    func createContact(contact: ContactModel) -> DataRequest {
        ...
        return Alamofire.request("\(baseUrl)/contacts",
                                 method: .post,
    ...
    func getContacts() -> DataRequest {
        ...
        return Alamofire.request("\(baseUrl)/contacts", method: .get, headers: [:])
    }
    
    func getContact(id: String) -> DataRequest {
        
        return Alamofire.request("\(baseUrl)/contacts/\(id)", method: .get, headers: [:])
    }
    
    func updateContact(id: String, contact: ContactModel) -> DataRequest {
        
        return Alamofire.request("\(baseUrl)/contacts/\(id)",
                                 method: .put,
                                 parameters: contact.toJSON(),
                                 encoding: JSONEncoding.default,
                                 headers: [:])
    ...
    func deleteContact(id: String) -> DataRequest {
        ...
        return Alamofire.request("\(baseUrl)/contacts/\(id)", method: .delete, headers: [:])
    }
}
